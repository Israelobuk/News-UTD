        ...
        for (const url of MARKET_MOVERS_URLS) {
          try {
            ...
            if (
              ...
              const apiSource = String(payload?.cache_source || "").trim().toLowerCase();
              const nextSource = apiSource === "postgres" ? "cached" : "live";
              setFramesByMode(nextFramesByMode);
              setFrameIndex(0);
              setMarketSource(nextSource);
              return;
            }
          } catch (error) {
            ...
            <span
              className={
                marketSource === "live"
                  ...
                  : marketSource === "cached"
                    ? "mini-stock-grid__status mini-stock-grid__status--cached"
